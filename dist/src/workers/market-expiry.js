...
async function runMarketExpiry(redis, oracleFinalizeQueue) {
    ...
    for (const market of expired) {
        ...
        if (alreadyQueued)
            continue;
        await oracleFinalizeQueue.add(`finalize:${market.marketId}`, { marketId: market.marketId, proposalAddress: market.address }, { jobId: `finalize:${market.marketId}` });
